...
def _load_stock_data():
    ...
    try:
        for attempt in range(3):
            ...
            if df is None:
                try:
                    # 当所有外部接口都失败时，使用预设的股票池
                    preset_stocks = [
                        {'代码': '000001', '名称': '平安银行', '最新价': 10.5, '涨跌幅': 0.5, '市盈率-动态': 6.5, '市净率': 0.6, '总市值': 2000, '换手率': 1.2},
                        {'代码': '000002', '名称': '万科A', '最新价': 8.2, '涨跌幅': -0.3, '市盈率-动态': 8.0, '市净率': 0.8, '总市值': 1500, '换手率': 0.8},
                        {'代码': '600036', '名称': '招商银行', '最新价': 32.5, '涨跌幅': 0.8, '市盈率-动态': 5.5, '市净率': 0.7, '总市值': 8000, '换手率': 0.5},
                        {'代码': '601318', '名称': '中国平安', '最新价': 45.0, '涨跌幅': 0.2, '市盈率-动态': 8.5, '市净率': 1.0, '总市值': 8000, '换手率': 0.6},
                        {'代码': '600519', '名称': '贵州茅台', '最新价': 1500.0, '涨跌幅': 0.5, '市盈率-动态': 25.0, '市净率': 8.0, '总市值': 18000, '换手率': 0.2},
                        {'代码': '000858', '名称': '五粮液', '最新价': 120.0, '涨跌幅': 0.3, '市盈率-动态': 20.0, '市净率': 5.0, '总市值': 5000, '换手率': 0.3},
                        {'代码': '002594', '名称': '比亚迪', '最新价': 250.0, '涨跌幅': 1.2, '市盈率-动态': 30.0, '市净率': 6.0, '总市值': 7000, '换手率': 1.5},
                        {'代码': '300750', '名称': '宁德时代', '最新价': 180.0, '涨跌幅': 0.8, '市盈率-动态': 35.0, '市净率': 5.5, '总市值': 7000, '换手率': 1.0},
                        {'代码': '601398', '名称': '工商银行', '最新价': 5.2, '涨跌幅': 0.1, '市盈率-动态': 4.5, '市净率': 0.5, '总市值': 18000, '换手率': 0.3},
                        {'代码': '601288', '名称': '农业银行', '最新价': 4.0, '涨跌幅': 0.0, '市盈率-动态': 4.0, '市净率': 0.4, '总市值': 14000, '换手率': 0.2},
                    ]
                    df = pd.DataFrame(preset_stocks)
                    print(f"[get_stock_data] 使用预设股票池, {len(df)} 行, 耗时 {time.time()-start:.1f}s")
                except Exception as e4:
                    errors.append(f"预设池: {str(e4)[:100]}")
                    print(f"[get_stock_data] 预设股票池也失败: {e4}")
